...
h 20-cv-create-all.log "content-view create --organization '$do' --product 'Red Hat Enterprise Linux Server' --repository-ids "5,6,4" --name "BenchContentView" --name 'BenchContentView'"
